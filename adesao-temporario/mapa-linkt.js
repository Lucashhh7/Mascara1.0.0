document.addEventListener('DOMContentLoaded', () => {
  ...
  form.addEventListener('submit', (event) => {
    ...
    const data_insta = document.getElementById('data_insta').value.trim();
    const inicio_even = document.getElementById('inicio_even').value.trim();
    const fim_even = document.getElementById('fim_even').value.trim();
...
Adesão de Link Temporario: ${admv}
Plano: ${planosFormatados}
Valor: ${valor}
Data de Instalação: ${data_insta}
Data de Inicio do Evento: ${inicio_even}
Final do Evento: ${fim_even}
